...
interventionSchema.pre('save', function(next) {
  ...
  console.log('🔄 Middleware pre-save - Statut:', this.statut);
  console.log('🔄 Middleware pre-save - DateFinEffective:', this.dateFinEffective);
  console.log('🔄 Middleware pre-save - DateValidation:', this.dateValidation);
  console.log('🔄 Middleware pre-save - Statut modifié?:', this.isModified('statut'));
  ...
  // ✅ Si le statut passe à "en_attente_validation" (technicien termine)
  if (this.isModified('statut') && this.statut === 'en_attente_validation' && !this.dateFinEffective) {
    this.dateFinEffective = now;
    this.heureFinEffective = heureActuelle;
    console.log('✅ Date de fin effective enregistrée (en attente):', this.dateFinEffective);
  ...
  // ✅ Si le statut passe à "terminee" depuis "en_attente_validation" (admin valide)
  if (this.isModified('statut') && this.statut === 'terminee' && !this.dateValidation) {
    this.dateValidation = now;
    this.heureValidation = heureActuelle;
    console.log('✅ Date de validation enregistrée:', this.dateValidation);
  ...
  console.log('✅ Après middleware - Statut final:', this.statut);
  console.log('✅ Après middleware - DateFinEffective final:', this.dateFinEffective);
  console.log('✅ Après middleware - DateValidation final:', this.dateValidation);
